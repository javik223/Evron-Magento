...
class Magestore_Webpos_Adminhtml_PosuserController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(
                Mage::helper('adminhtml')->__('POS User Manager'),
                Mage::helper('adminhtml')->__('POS User Manager')
            );
        return $this;
    }
    ...
    public function editAction()
    {
        ...
        if (Mage::helper('webpos')->isInventoryWebPOS11Active()) {
            $modelCollection->getSelect()
                    ->joinLeft(array('webpos_user_warehouse' => $modelCollection->getTable('inventorywebpos/webposuser')), "main_table.user_id = webpos_user_warehouse.user_id", array('warehouse_id'));
        }
        ...
        if ($model->getId() || $userId == 0) {
            ...
            $this->_addBreadcrumb(
                Mage::helper('adminhtml')->__('POS User News'),
                Mage::helper('adminhtml')->__('POS User News')
            );
