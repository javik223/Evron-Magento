...
class Magestore_Inventoryshipment_Adminhtml_Ins_InventoryshipmentController extends Magestore_Inventoryplus_Controller_Action
{
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('inventoryplus/stock_out/shipment')
            ->_addBreadcrumb(
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $inventoryshipmentId == 0) {
            ...
            $this->loadLayout()->_setActiveMenu('inventoryplus/stock_out/shipment');
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('inventoryplus/stock_out/shipment');
    }
}