...
class Magestore_Inventorylowstock_Adminhtml_Inl_NotificationlogController extends Magestore_Inventoryplus_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('inventoryplus/stock_onhand/lowstock')
                ->_addBreadcrumb(
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('inventoryplus/stock_onhand/lowstock');
    }
    ...
    public function viewAction() {
        ...
        if ($model->getId()) {
            ...
            $this->loadLayout()->_setActiveMenu('inventoryplus/stock_onhand/lowstock');
