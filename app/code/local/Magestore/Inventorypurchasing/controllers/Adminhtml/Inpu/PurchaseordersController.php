 ...
 */
class Magestore_Inventorypurchasing_Adminhtml_Inpu_PurchaseordersController extends Magestore_Inventoryplus_Controller_Action {

    public function indexAction() {
        $this->loadLayout()
                ->_setActiveMenu('inventoryplus/stock_in/purchaseorder');
    ...
    public function editAction() {
        ...
        if ($model->getId() || $purchaseOrderId == 0) {
            ...
            $this->loadLayout()->_setActiveMenu('inventoryplus/stock_in/purchaseorder');
...
//        require("lib/Magestore/Pdf/html2fpdf.php");
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('inventoryplus/stock_in/purchaseorder');
    }
