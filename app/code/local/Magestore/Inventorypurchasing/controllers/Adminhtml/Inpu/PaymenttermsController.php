...
class Magestore_Inventorypurchasing_Adminhtml_Inpu_PaymenttermsController extends Magestore_Inventoryplus_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('inventoryplus/settings/purchase_order/paymentterms')
                ->_addBreadcrumb(
    ...
    public function editAction() {
        ...
        if ($model->getId() || $paymentTermId == 0) {
            ...
            $this->loadLayout()->_setActiveMenu('inventoryplus/settings/purchase_order/paymentterms');
            $this->_addBreadcrumb(
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('inventoryplus/settings/purchase_order/paymentterms');
    }
