...
class Magestore_Inventorypurchasing_Adminhtml_Inpu_ShippingmethodsController extends Magestore_Inventoryplus_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('inventoryplus/settings/purchase_order/shippingmethod')
                ->_addBreadcrumb(
    ...
    public function editAction() {
        ...
        if ($model->getId() || $shippingMethodId == 0) {
            ...
            $this->loadLayout()->_setActiveMenu('inventoryplus/settings/purchase_order/shippingmethod');
            $this->_addBreadcrumb(
